...
// This file was genereted from "C:\\Users\\vitor_000\\Documents\\Overture\\workspace\\MFES_SHOGI\\classes\\Lance.vdmpp".
      ...
      if (promoted.booleanValue()) 
        ...
        if ((rexpr_4 = Boolean.valueOf((c1.x).intValue() == (c2.x).intValue())).booleanValue()) {
          boolean tmpQuant_11 = false;
          {
            ...
            Number y = null;
            Set tmpSet_106 = new HashSet(e_set_12);
            for (Iterator enm_105 = tmpSet_106.iterator(); enm_105.hasNext() && !tmpQuant_11; ) {
              Number elem_104 = UTIL.NumberToInt(enm_105.next());
              /* y */
              y = elem_104;
