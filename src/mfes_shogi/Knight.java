...
// This file was genereted from "D:\\FEUP\\4o ano\\1o Semestre\\MFES\\MFES_SHOGI\\MFES_SHOGI\\classes/Knight.vdmpp".
    ...
    try {
      if (promoted.booleanValue()) 
        ...
        if ((var1_5 = var1_6).booleanValue()) {
          ...
          if (!(var2_31 = Boolean.valueOf(UTIL.equals((c2.piece), null))).booleanValue()) {
            Boolean var2_36 = null;
            if ((var2_36 = Boolean.valueOf(!UTIL.equals((c2.piece), null))).booleanValue()) 
              var2_36 = Boolean.valueOf(!UTIL.equals(((c2.piece).belongTo), ((c1.piece).belongTo)));
            var2_31 = var2_36;
          }
          var1_5 = var2_31;
        }
