...
// ***** VDMTOOLS START Name=BoardSentinel KEEP=NO
  class BoardSentinel extends Sentinel {
    ...
    public final int getAllCellsFromPlayer = 21;

    public final int getPlayersFarthestRank = 22;

    public final int check__2_n_Player_n_Cell = 23;

    public final int checkIfPawnDroppedCheck = 24;

    public final int getPlayersSecondFarthestRank = 25;

    public final int nr_functions = 26;
