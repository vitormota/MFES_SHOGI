...
// This file was genereted from "C:\\Users\\vitor_000\\Documents\\Overture\\workspace\\MFES_SHOGI\\classes\\Board.rtf".
...
// ***** VDMTOOLS START Name=BoardSentinel KEEP=NO
    class BoardSentinel extends Sentinel {
        ...
        public final int hasValidMove = 11;

        public final int checkAfterEat = 12;

        public final int needsToPromote = 13;

        public final int getCurrentState = 14;

        public final int inPromotionZone = 15;

        public final int getAllEmptyCells = 16;

        public final int getCheckingPiece = 17;

        public final int getCapturedPieces = 18;

        public final int getKingFromPlayer = 19;

        public final int existsPawnInColumn = 20;

        public final int getCurrentStateLine = 21;

        public final int getPossibleToPromote = 22;

        public final int getAllCellsFromPlayer = 23;

        public final int check__1_n_Board___Player = 24;

        public final int getPlayersFarthestRank = 25;

        public final int check__2_n_Player_n_Cell = 26;

        public final int checkIfPawnDroppedCheck = 27;

        public final int getPlayersSecondFarthestRank = 28;

        public final int nr_functions = 29;
...
// ***** VDMTOOLS START Name=inv_Board KEEP=NO
    public Boolean inv_Board() throws CGException {
        Boolean rexpr_204 = null;
        Boolean var1_205 = null;
        if ((var1_205 = Boolean.valueOf(new HashSet(lines.keySet()).size() == 9)).booleanValue()) {
            Set var2_214 = new HashSet();
            var2_214 = new HashSet();
            for (int count_217 = 1; count_217 <= 9; count_217++) {
                var2_214.add(new Integer(count_217));
            }
            var1_205 = Boolean.valueOf(UTIL.equals(new HashSet(lines.keySet()), var2_214));
        }
        if ((rexpr_204 = var1_205).booleanValue()) {
            Boolean var2_220 = null;
            boolean tmpQuant_222 = true;
            {
                Set e1_set_225 = new HashSet(capturedPieces.values());
                List seqp = null;
                Set tmpSet_252 = new HashSet(e1_set_225);
                for (Iterator enm_251 = tmpSet_252.iterator(); enm_251.hasNext() && tmpQuant_222;) {
                    List elem_250 = UTIL.ConvertToList(enm_251.next());
                    /* seqp */
                    seqp = elem_250;
                    Boolean pred_226 = null;
                    if ((pred_226 = Boolean.valueOf(seqp.size() == new HashSet(seqp).size())).booleanValue()) {
                        boolean tmpQuant_234 = true;
                        {
                            Set e1_set_237 = new HashSet(seqp);
                            Piece p = null;
                            Set tmpSet_248 = new HashSet(e1_set_237);
                            for (Iterator enm_247 = tmpSet_248.iterator(); enm_247.hasNext() && tmpQuant_234;) {
                                Piece elem_246 = (Piece) enm_247.next();
                                /* p */
                                p = elem_246;
                        ...
                        pred_226 = Boolean.valueOf(tmpQuant_234);
                    }
                    if (!pred_226.booleanValue()) {
                        tmpQuant_222 = false;
                    }
                }
            }
            if ((var2_220 = Boolean.valueOf(tmpQuant_222)).booleanValue()) {
                Boolean var2_253 = null;
                if (!(var2_253 = Boolean.valueOf(UTIL.equals(lastPlayedPiece, null))).booleanValue()) {
                    var2_253 = Boolean.valueOf(UTIL.equals(lastPlayedPiece, getCell((lastPlayedPiece.x), (lastPlayedPiece.y))));
                }
                var2_220 = var2_253;
            }
            rexpr_204 = var2_220;
...
// ***** VDMTOOLS START Name=hasValidMove#2|Cell|Piece KEEP=NO
    public Boolean hasValidMove(final Cell c, final Piece p) throws CGException {
        sentinel.entering(((BoardSentinel) sentinel).hasValidMove);
        try {
            if (!this.pre_hasValidMove(c, p).booleanValue()) {
                UTIL.RunTime("Precondition failure in hasValidMove");
            }
            {
                Boolean ret = null;
                c.piece = (Piece) p;
                ...
                boolean tmpQuant_6 = false;
                {
                    Set e_set_7 = new HashSet();
                    e_set_7 = new HashSet();
                    for (int count_10 = 1; count_10 <= 9; count_10++) {
                        e_set_7.add(new Integer(count_10));
                    }
                    Number x = null;
                    Number y = null;
                    Set e_set_25 = e_set_7;
                    Set tmpSet_28 = new HashSet(e_set_25);
                    for (Iterator enm_27 = tmpSet_28.iterator(); enm_27.hasNext() && !tmpQuant_6;) {
                        Number elem_26 = UTIL.NumberToInt(enm_27.next());
                        /* y */
                        y = elem_26;
                        Set tmpSet_24 = new HashSet(e_set_7);
                        for (Iterator enm_23 = tmpSet_24.iterator(); enm_23.hasNext() && !tmpQuant_6;) {
                            Number elem_22 = UTIL.NumberToInt(enm_23.next());
                            /* x */
                            x = elem_22;
                            Piece obj_16 = (c.piece);
                            if (obj_16.validMovement(c, getCell(x, y)).booleanValue()) {
                                tmpQuant_6 = true;
                            }
                        }
                    }
                }
                ret = (Boolean) UTIL.clone(Boolean.valueOf(tmpQuant_6));
                if (!this.inv_Board().booleanValue()) {
                    UTIL.RunTime("Instance invariant failure in Board");
                }
                c.piece = null;
            ...
            sentinel.leaving(((BoardSentinel) sentinel).hasValidMove);
        }
    }
// ***** VDMTOOLS END Name=hasValidMove#2|Cell|Piece

// ***** VDMTOOLS START Name=pre_hasValidMove#2|Cell|Piece KEEP=NO
    public Boolean pre_hasValidMove(final Cell c, final Piece p) throws CGException {
        return Boolean.valueOf(UTIL.equals((c.piece), null));
    }
// ***** VDMTOOLS END Name=pre_hasValidMove#2|Cell|Piece
...
// ***** VDMTOOLS START Name=pre_dropPiece#2|Cell|Piece KEEP=NO
    public Boolean pre_dropPiece(final Cell c, final Piece p) throws CGException {
        ...
        Boolean var1_5 = null;
        Boolean var1_6 = null;
        if ((var1_6 = Boolean.valueOf(UTIL.equals((c.piece), null))).booleanValue()) {
            var1_6 = Boolean.valueOf(UTIL.Contains(new HashSet(UTIL.ConvertToList(capturedPieces.get(turn))), p));
        }
        if ((var1_5 = var1_6).booleanValue()) {
            var1_5 = Boolean.valueOf(!existsPawnInColumn(c, p).booleanValue());
        }
        if ((var1_4 = var1_5).booleanValue()) {
            var1_4 = Boolean.valueOf(!checkIfPawnDroppedCheck(c, p).booleanValue());
        }
        if ((varRes_3 = var1_4).booleanValue()) {
            varRes_3 = hasValidMove(c, p);
        }
        return varRes_3;
    }
...
// ***** VDMTOOLS START Name=pre_move#2|Cell|Cell KEEP=NO
    public Boolean pre_move(final Cell c1, final Cell c2) throws CGException {
        ...
        Boolean var1_7 = null;
        Boolean var1_8 = null;
        if ((var1_8 = Boolean.valueOf(UTIL.equals(c1, getCell((c1.x), (c1.y))))).booleanValue()) {
            var1_8 = Boolean.valueOf(UTIL.equals(c2, getCell((c2.x), (c2.y))));
        }
        if ((var1_7 = var1_8).booleanValue()) {
            var1_7 = Boolean.valueOf(!UTIL.equals((c1.piece), null));
        }
        if ((var1_6 = var1_7).booleanValue()) {
            Piece obj_30 = (c1.piece);
            var1_6 = obj_30.validMovement(c1, c2);
        }
        if ((var1_5 = var1_6).booleanValue()) {
            var1_5 = Boolean.valueOf(UTIL.equals(lastPlayedPiece, null));
        }
        if ((var1_4 = var1_5).booleanValue()) {
...
// ***** VDMTOOLS START Name=endRound KEEP=NO
    public void endRound() throws CGException {
        ...
        try {
            ...
            tmpSeq_9.add(new BoardState(getCurrentState(new Integer(1)), capturedPieces));
            ...
            if (endGame().booleanValue()) {
                if (stateEquals().size() >= 4) {
                    gameState = new quotes.Draw();
                    if (!this.inv_Board().booleanValue()) {
                        UTIL.RunTime("Instance invariant failure in Board");
                    }
                } else if (UTIL.equals(turn, new quotes.White())) {
    ...
    private Boolean inPromotionZone(final Cell c, final Object p) throws CGException {
        ...
        try {
            ...
            if ((cond_3 = Boolean.valueOf(UTIL.equals(p, new quotes.White()))).booleanValue()) {
                cond_3 = Boolean.valueOf((c.y).intValue() > 6);
            }
...
// ***** VDMTOOLS START Name=needsToPromote#1|Cell KEEP=NO
    private Boolean needsToPromote(final Cell c) throws CGException {
        ...
        try {
            if (!this.pre_needsToPromote(c).booleanValue()) {
                UTIL.RunTime("Precondition failure in needsToPromote");
            }
            Boolean cond_2 = null;
            Boolean var1_3 = null;
            if (!(var1_3 = Boolean.valueOf((c.piece) instanceof Pawn)).booleanValue()) {
                var1_3 = Boolean.valueOf((c.piece) instanceof Lance);
            }
            if ((cond_2 = var1_3).booleanValue()) {
                cond_2 = Boolean.valueOf((c.y).intValue() == getPlayersFarthestRank(((c.piece).belongTo)).intValue());
            }
            if (cond_2.booleanValue()) {
                return Boolean.TRUE;
            }
            Boolean cond_18 = null;
            if ((cond_18 = Boolean.valueOf((c.piece) instanceof Knight)).booleanValue()) {
                Boolean var2_22 = null;
                if (!(var2_22 = Boolean.valueOf((c.y).intValue() == getPlayersSecondFarthestRank(((c.piece).belongTo)).intValue())).booleanValue()) {
                    var2_22 = Boolean.valueOf((c.y).intValue() == getPlayersFarthestRank(((c.piece).belongTo)).intValue());
                }
                cond_18 = var2_22;
            }
...
// ***** VDMTOOLS START Name=pre_needsToPromote#1|Cell KEEP=NO
    private Boolean pre_needsToPromote(final Cell c) throws CGException {
        return Boolean.valueOf(!UTIL.equals((c.piece), null));
    }
// ***** VDMTOOLS END Name=pre_needsToPromote#1|Cell
...
// ***** VDMTOOLS START Name=check#1|Object KEEP=NO
    public Boolean check(final Object p) throws CGException {
        sentinel.entering(((BoardSentinel) sentinel).check__1_n_Board___Player);
        try {
            ...
            sentinel.leaving(((BoardSentinel) sentinel).check__1_n_Board___Player);
        }
    }
...
// ***** VDMTOOLS START Name=getCheckingPiece#1|Object KEEP=NO
    public Set getCheckingPiece(final Object p) throws CGException {
        ...
        try {
            Set res_s_3 = new HashSet();
            {
                Set e1_set_9 = getAllCellsFromPlayer(getOtherPlayer(p), new Integer(1));
                Cell c = null;
                Set tmpSet_20 = new HashSet(e1_set_9);
                for (Iterator enm_19 = tmpSet_20.iterator(); enm_19.hasNext();) {
                    Cell elem_18 = (Cell) enm_19.next();
                    /* c */
                    c = elem_18;
                    Piece obj_13 = (c.piece);
                    if (obj_13.validMovement(c, getKingFromPlayer(p)).booleanValue()) {
                        res_s_3.add(c);
                    }
                }
            }
    ...
    public Boolean endGame() throws CGException {
        ...
        try {
            ...
            if ((var1_2 = check(turn)).booleanValue()) {
                ...
                {
                    Set e1_set_11 = getAllEmptyCells(new Integer(1));
                    Cell c = null;
                    Set tmpSet_23 = new HashSet(e1_set_11);
                    for (Iterator enm_22 = tmpSet_23.iterator(); enm_22.hasNext() && !tmpQuant_8;) {
                        Cell elem_21 = (Cell) enm_22.next();
                        /* c */
                        c = elem_21;
                        Piece obj_16 = (getKingFromPlayer(turn).piece);
                        if (obj_16.validMovement(getKingFromPlayer(turn), c).booleanValue()) {
                            tmpQuant_8 = true;
                        }
                    }
                }
                if (!(var2_5 = Boolean.valueOf(!tmpQuant_8)).booleanValue()) {
                    boolean tmpQuant_26 = false;
                    {
                        Set e1_set_29 = getCheckingPiece(turn);
                        Set e1_set_33 = getAllCellsFromPlayer(turn, new Integer(1));
                        Cell c2 = null;
                        Cell checking = null;
                        Set tmpSet_51 = new HashSet(e1_set_33);
                        for (Iterator enm_50 = tmpSet_51.iterator(); enm_50.hasNext() && !tmpQuant_26;) {
                            Cell elem_49 = (Cell) enm_50.next();
                            /* c2 */
                            c2 = elem_49;
                            Set tmpSet_48 = new HashSet(e1_set_29);
                            for (Iterator enm_47 = tmpSet_48.iterator(); enm_47.hasNext() && !tmpQuant_26;) {
                                Cell elem_46 = (Cell) enm_47.next();
                                /* checking */
                                checking = elem_46;
                                Boolean pred_34 = null;
                                Piece obj_38 = (c2.piece);
                                if ((pred_34 = obj_38.validMovement(c2, checking)).booleanValue()) {
                                    pred_34 = Boolean.valueOf(!checkAfterEat(c2, checking).booleanValue());
                                }
                    ...
                    var2_5 = Boolean.valueOf(!tmpQuant_26);
                }
                var1_2 = var2_5;
            }
...
// ***** VDMTOOLS START Name=checkAfterEat#2|Cell|Cell KEEP=NO
    public Boolean checkAfterEat(final Cell c1, final Cell c2) throws CGException {
        sentinel.entering(((BoardSentinel) sentinel).checkAfterEat);
        try {
            if (!this.pre_checkAfterEat(c1, c2).booleanValue()) {
                UTIL.RunTime("Precondition failure in checkAfterEat");
            }
            {
                Piece aux = c2.piece;
                Boolean ret = null;
                ...
                ret = (Boolean) UTIL.clone(check(turn));
                if (!this.inv_Board().booleanValue()) {
                    UTIL.RunTime("Instance invariant failure in Board");
                }
            ...
            sentinel.leaving(((BoardSentinel) sentinel).checkAfterEat);
        }
    }
// ***** VDMTOOLS END Name=checkAfterEat#2|Cell|Cell

// ***** VDMTOOLS START Name=pre_checkAfterEat#2|Cell|Cell KEEP=NO
    public Boolean pre_checkAfterEat(final Cell c1, final Cell c2) throws CGException {
        Boolean varRes_3 = null;
        if ((varRes_3 = Boolean.valueOf(!UTIL.equals((c1.piece), null))).booleanValue()) {
            varRes_3 = Boolean.valueOf(UTIL.equals(((c1.piece).belongTo), turn));
        }
        return varRes_3;
    }
// ***** VDMTOOLS END Name=pre_checkAfterEat#2|Cell|Cell
