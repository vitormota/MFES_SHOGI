...
// ***** VDMTOOLS START Name=BoardSentinel KEEP=NO
  class BoardSentinel extends Sentinel {
    ...
    public final int getLines = 4;

    public final int dropPiece = 5;

    public final int getInstance = 6;

    public final int stateEquals = 7;

    public final int getGameState = 8;

    public final int getCurrentState = 9;

    public final int check__1_n_Player = 10;

    public final int getAllEmptyCells = 11;

    public final int getCheckingPiece = 12;

    public final int getCapturedPieces = 13;

    public final int getKingFromPlayer = 14;

    public final int existsPawnInColumn = 15;

    public final int getCurrentStateLine = 16;

    public final int getAllCellsFromPlayer = 17;

    public final int check__2_n_Player_n_Cell = 18;

    public final int checkIfPawnDroppedCheck = 19;
...
// ***** VDMTOOLS START Name=move#2|Cell|Cell KEEP=NO
  public void move (final Cell c1, final Cell c2) throws CGException {
    ...
    try {
      ...
      tmpSeq_32.add(new BoardState(getCurrentState(new Integer(1)), capturedPieces, turn));
      rhs_30 = new ArrayList(tmpSeq_32);
      rhs_30.addAll(allMoves);
      allMoves = UTIL.ConvertToList(UTIL.clone(rhs_30));
      if (!this.inv_Board().booleanValue()) 
        UTIL.RunTime("Instance invariant failure in Board");
...
// ***** VDMTOOLS START Name=getCurrentState#1|Number KEEP=NO
  public List getCurrentState (final Number y) throws CGException {
    try {
