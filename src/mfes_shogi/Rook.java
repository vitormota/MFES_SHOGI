...
// This file was genereted from "C:\\Users\\vitor_000\\Documents\\Overture\\workspace\\MFES_SHOGI\\classes\\Rook.rtf".
    ...
    try {
      ...
      if (!(rexpr_3 = var1_4).booleanValue()) {
        ...
        if ((var1_104 = var1_105).booleanValue()) 
          var1_104 = notFriend(c1, c2);
        if ((var2_103 = var1_104).booleanValue()) 
          var2_103 = Boolean.valueOf(!protectingKing(c1, c2).booleanValue());
        rexpr_3 = var2_103;
      }
      return rexpr_3;
    }
